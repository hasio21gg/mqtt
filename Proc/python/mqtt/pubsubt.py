...
cmdUtils.register_command("recvtopic", "<str>", "★受信トピックを指定する", True, str)
...
if __name__ == '__main__':
    ...
    print("Sendlist is {}".format(sendlist))
    ...
    message_topic_recv = "{}{}/#".format(message_topic_recv_prefix ,cmdUtils.get_command("recvtopic"))
    print(message_topic_recv)
